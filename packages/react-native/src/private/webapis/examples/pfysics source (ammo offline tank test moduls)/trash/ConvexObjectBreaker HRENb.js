...
if ( subObject.geometry._bufferGeometry === undefined ) {

subObject.geometry._bufferGeometry = new THREE.BufferGeometry().setFromObject( subObject );
			...
			// Perform the cut
			//console.log(subObject.geometry._bufferGeometry.attributes.position.array)
...
console.log(scope)
	...
	cutByPlane: function ( object, plane, output ) {
		...
		var geometry = object.geometry;
				...
				//}
				//console.log(geometry._bufferGeometry.attributes)
		var coords = geometry._bufferGeometry.attributes.position.array;
		var normals = geometry._bufferGeometry.attributes.normal.array;

		var numPoints = coords.length / 3;
		var numFaces = numPoints / 3;
//console.log(geometry._bufferGeometry.getIndex())
		var indices = geometry._bufferGeometry.getIndex();
